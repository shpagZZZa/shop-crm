 ...
 */
final class Version20210130102536 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, title_id INT NOT NULL, description VARCHAR(255) NOT NULL, subdescription VARCHAR(255) DEFAULT NULL, INDEX IDX_64C19C1A9F87BD (title_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE shop (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, settings LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', backend_url VARCHAR(255) NOT NULL, unique_id VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE category ADD CONSTRAINT FK_64C19C1A9F87BD FOREIGN KEY (title_id) REFERENCES shop (id)');
